...
import { Home, Edit, Trash2, MapPin, User, Scale, Activity } from 'lucide-react';
          ...
          <TableRow className="hover:bg-transparent border-none">
            <TableCell colSpan={5} className="px-6 py-20 text-center">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-foreground font-bold italic text-muted-foreground">No se encontraron propiedades registradas</p>
              </div>
            </TableCell>
          </TableRow>
        ) : (
          propiedades.map((propiedad) => (
            <TableRow key={propiedad.id} className="group hover:bg-primary/5 transition-all duration-300">
