            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground font-medium pl-12">
                        Administra los tipos de animales disponibles para las inspecciones y avales.
                    </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Can screen="animales" action="create">
                        <Button onClick={handleOpenCreate} title='crea un nuevo animal' variant={"primary"}>
                        <Plus className="size-5 text-white" /> <span className="text-white">Nuevo animal</span>
                    </Button>
                    </Can>
                </div>
            </div>
                ...
                <AlertDialogContent className="glass-effect border-rose-500/20 max-w-md">
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="text-center font-medium px-4">
                            Esta acción borrará permanentemente este animal. Los datos asociados podrían verse afectados.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
