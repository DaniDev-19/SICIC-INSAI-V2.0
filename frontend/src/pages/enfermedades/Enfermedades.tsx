...
const Enfermedades: React.FC = () => {
  ...
  const confirmDelete = async () => {
    if (deleteId) {
      await deleteEnfermedad(deleteId);
      setDeleteId(null);
    }
  };
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground font-medium pl-12">
            Administra las enfermedades disponibles para las inspecciones y programas.
          </p>
        </div>
        ...
        <AlertDialogContent className="glass-effect border-rose-500/20 max-w-md">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-center font-medium px-4">
              Esta acción borrará permanentemente esta enfermedad. Los datos asociados podrían verse afectados.
            </AlertDialogDescription>
          </AlertDialogHeader>
