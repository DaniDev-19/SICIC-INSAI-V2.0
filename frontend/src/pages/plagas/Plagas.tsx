            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground font-medium pl-12">
                        Administra los tipos de plagas disponibles para las inspecciones y programas.
                    </p>
                </div>
                ...
                <AlertDialogContent className="glass-effect border-rose-500/20 max-w-md">
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="text-center font-medium px-4">
                            Esta acción borrará permanentemente esta plaga. Los datos asociados podrían verse afectados.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
